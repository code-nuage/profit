...
return function(router)
    ...
    :add_route("/cart/product/:id", "DELETE", function(req, res)
        res.status, res.body, res.header["Content-Type"] = controller_cart.remove_product(req.body, tonumber(req.params.id))
    end)
